    ...
    return(
        <>
            <div className='container'>
                ...
                <button className='view-all-btn btn-1' onClick={() => navigate(`/ViewTvPopular`)}>
                    View All
                </button>
                <TvPopular/>
            </div>
            <div className='container airing-cont'>
                ...
                <button className='view-all-btn btn-2' onClick={() => navigate(`/ViewTvAiringToday`)}>
                    View All
                </button>
                <TvAiringToday/>
            </div>
            <div className='container onair-cont'>
                ...
                <button className='view-all-btn btn-3' onClick={() => navigate(`/ViewTvOnAir`)}>
                    View All
                </button>
                <TvOnAir/>
            </div>
            <div className='container leader-cont'>
                ...
                <button className='view-all-btn btn-4' onClick={() => navigate(`/ViewTvLeader`)}>
                    View All
                </button>
                <TvLeaderBoard/>
            </div>
